...
const PrivactyPolicyPage = () => (
    <Layout>
        ...
        <div style={{ color: `white`, maxWidth: `960px`, padding: `20px`, margin:`0 auto` }}>
            ...
            <p>Connor Jaksik's Web Portfolio uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>Connor Jaksik's Web Portfolio will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h2>Disclosure Of Data</h2>

            <h3>Legal Requirements</h3>
            <p>Connor Jaksik's Web Portfolio may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Connor Jaksik's Web Portfolio</li>
