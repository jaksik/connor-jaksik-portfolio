    ...
    <div className="landing-wrapper">
      ...
      <div style={{ position: `absolute`, zIndex: `1`, width: `100%` }}>
        ...
        <div className="ground">
          ...
          <Img fluid={data.background.childImageSharp.fluid} style={{ position: `absolute`, width: `100%`, height: `100%`, marginTop: `100%` }} />
          {/* <Img fluid={data.background.childImageSharp.fluid} style={{ width: `100%`, height: `100vh`, marginTop: `100vh` }} /> */}
          <div className="content-container">
